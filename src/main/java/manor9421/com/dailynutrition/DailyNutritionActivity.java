...
public class DailyNutritionActivity extends Activity implements DailyNutritionFragment.ProdDetailsListCallback{
    ...
    public void onDetailsListItemClick(int item) {
        Intent intent = new Intent(this,DailyNutritionDetailsActivity.class);
